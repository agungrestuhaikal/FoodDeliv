...
<nav class="menu-nav mt-5 d-flex justify-content-center gap-3">
    ...
    <a href="{{ route('favorites.menus') }}" class="btn btn-outline-danger shadow-sm">
        <i class="bi bi-heart-fill me-1"></i> Menu Favorit
    </a>
    <a href="{{ route('favorites.orders') }}" class="btn btn-outline-warning shadow-sm">
